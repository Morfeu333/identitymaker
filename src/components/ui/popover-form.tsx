    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="w-full bg-muted shadow-form outline-none rounded-lg overflow-hidden"
          ref={ref}
          style={{ 
            borderRadius: 10, 
            ...
            <AnimatePresence mode="popLayout">
              {showSuccess ? (
                ...
                <motion.div
                  ...
                  className="border bg-card dark:bg-card z-20 overflow-visible"
                  layout
                >
                  {openChild}
                </motion.div>
...
export function PopoverFormButton({
  ...
  return (
    <button
      type="submit"
      className="ml-auto flex h-6 w-26 items-center justify-center overflow-hidden rounded-md bg-gradient-button px-3 text-xs font-semibold text-primary-foreground shadow-button-custom"
    >
